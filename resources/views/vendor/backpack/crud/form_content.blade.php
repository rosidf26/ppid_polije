...
@section('after_styles')
    ...
    <link rel="stylesheet" href="{{ url(config('app.url') . '/polije-admin/vendor/backpack/crud/css/'.$action.'.css').'?v='.config('backpack.base.cachebusting_string') }}">
...
@section('after_scripts')
    ...
    <script src="{{ url(config('app.url') . '/polije-admin/vendor/backpack/crud/js/'.$action.'.js').'?v='.config('backpack.base.cachebusting_string') }}"></script>
