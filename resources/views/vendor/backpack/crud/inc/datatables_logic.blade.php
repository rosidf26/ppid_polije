 ...
 @endphp
  ...
  {{-- DATA TABLES SCRIPT --}}
  <script type="text/javascript" src="{{ url(config('app.url') . '/polije-admin/vendor/datatables.net/js/jquery.dataTables.min.js') }}"></script>
  <script type="text/javascript" src="{{ url(config('app.url') . '/polije-admin/vendor/datatables.net-bs4/js/dataTables.bootstrap4.min.js') }}"></script>
  <script type="text/javascript" src="{{ url(config('app.url') . '/polije-admin/vendor/datatables.net-responsive/js/dataTables.responsive.min.js') }}"></script>
  <script type="text/javascript" src="{{ url(config('app.url') . '/polije-admin/vendor/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js') }}"></script>
  <script type="text/javascript" src="{{ url(config('app.url') . '/polije-admin/vendor/datatables.net-fixedheader/js/dataTables.fixedHeader.min.js') }}"></script>
  <script type="text/javascript" src="{{ url(config('app.url') . '/polije-admin/vendor/datatables.net-fixedheader-bs4/js/fixedHeader.bootstrap4.min.js') }}"></script>
      ...
      dataTableConfiguration: {
        ...
        */
        ...
        language: {
              ...
              "processing":     "<img src='{{ url(config('app.url') . '/polije-admin/vendor/backpack/crud/img/ajax-loader.gif') }}' alt='{{ trans('backpack::crud.processing') }}'>",
              "search": "_INPUT_",
