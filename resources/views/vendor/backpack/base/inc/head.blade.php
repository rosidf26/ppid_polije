...
<link rel="stylesheet"
    href="{{ url(config('app.url') . '/polije-admin/vendor/bootstrap-datepicker/css/bootstrap-datepicker3.css') }}" />
...
<link rel="stylesheet"
    href="{{ url(config('app.url') . '/polije-admin/vendor/bootstrap-multiselect/css/bootstrap-multiselect.css') }}" />
