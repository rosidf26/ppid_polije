                        ...
                        <div class="blog-posts single-post">
                            ...
                            <article class="post post-large blog-single-post border-0 m-0 p-0">
                                <div class="post-content ml-0">
                                    ...
                                    <h4 class="mb-3">Informasi Publik yang Wajib Diumumkan Secara Serta Merta</h4>
                                        ...
                                        <table class="table table-striped mt-3">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        Pengumuman Kegiatan Akademik, Cuti Bersama Hari Suci Nyepi dan Idul Fitri 1446 H
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        Pengumuman Upacara Hardiknas Tahun 2024
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        Pengumuman Pelaksanaan Bekerja dari Rumah/WFH
                                                    </td>
                                                    <td>
                                                        <a class="btn btn-outline btn-success btn-xs" href="#" target="_blank">Lihat<span><i class="fas fa-chevron-right"></i></span></a>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        Penyesuaian Jam Kerja pada Bulan Ramadhan 1446 H
                                                    </td>
                                                    <td>
                                                        <a class="btn btn-outline btn-success btn-xs" href="#" target="_blank">Lihat<span><i class="fas fa-chevron-right"></i></span></a>
                                                    </td>
