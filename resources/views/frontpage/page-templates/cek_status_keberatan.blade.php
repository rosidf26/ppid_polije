            ...
            <div class="container py-4">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <form method="POST" action="{{ route('keberatan.cek-status.result') }}">
                            @csrf

                            <div class="form-group">
                                <label><strong>Nomor Permohonan Keberatan</strong></label>
                                <input type="text" name="unik_request"
                                    class="form-control @error('unik_request') is-invalid @enderror"
                                    placeholder="Masukkan Nomor Permohonan, Contoh: KB-20250101123000-ABC123" value="{{ old('unik_request') }}"
                                    required>
