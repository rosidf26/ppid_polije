    ...
    <div class="body">
      ...
      <div role="main" class="main">
        ...
        <div class="container py-4">
          <div class="row">
            <div class="col">
              <h2 class="font-weight-normal text-7 mb-0">Menampilkan pencarian dari kata kunci <strong class="font-weight-extra-bold">{{ $request->get('q') }}</strong>
              </h2>
              ...
              <div class="col">
                <form action="{{ route('search_news') }}" method="get">
                  <div class="input-group input-group-lg">
                    <input class="form-control" placeholder="Cari berita..." name="q" value="{{ $request->get('q') }}" id="q" type="text">
