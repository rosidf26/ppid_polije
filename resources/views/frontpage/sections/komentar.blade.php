        ...
        <div class="row">
            <div class="col-md-9 col-lg-9">
                <div class="call-to-action-content">
                    <h2 class="font-weight-normal text-6 mb-0">Berikan Komentar Anda Terhadap Layanan Kami. Terima Kasih
                    </h2>
                </div>
            </div>
            <div class="col-md-3 col-lg-3">
                <div class="call-to-action-btn">
                    <a href="{{ url('komentar') }}"
                        class="btn btn-success btn-lg text-3 font-weight-semibold px-4 py-3">KLIK DISINI</a><span
