				...
				<div class="row flex-grow-1">
					<div class="col-auto pr-0">
						<div class="post-date detail">
							...
							<span
								class="month">{{ \Carbon\Carbon::parse($value->date)->translatedFormat('M') }}</span>
							<span
								class="year">{{ \Carbon\Carbon::parse($value->date)->translatedFormat('Y') }}</span>
						</div>
					</div>
